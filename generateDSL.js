...
// Load the Person, System, and Relationships
...
relation_person_person_query.records.forEach(record => output.text(record.getCellValue("Person_From_Variable") 
                                         + " -> " + record.getCellValue("Person_To_Variable") + " \"" + record.getCellValue("Relationship") + "\"" + " \"" + record.getCellValue(
                                           "Description") + "\""));


// All the relationship type System to System
output.text("# System to System");
relation_system_system_query.records.forEach(record => output.text(record.getCellValue("System_From_Variable") 
                                         + " -> " + record.getCellValue("System_To_Variable") + " \"" + record.getCellValue("Relationship") + "\"" + " \"" + record.getCellValue(
                                           "Description") + "\""));

// All the relationship type System to Person
output.text("# System to Person");
relation_system_person_query.records.forEach(record => output.text(record.getCellValue("System_From_Variable") 
                                         + " -> " + record.getCellValue("Person_To_Variable") + " \"" + record.getCellValue("Relationship") + "\"" + " \"" + record.getCellValue(
                                           "Description") + "\""));
...
relation_person_system_query.records.forEach(record => output.text(record.getCellValue("Person_From_Variable") 
                                         + " -> " + record.getCellValue("System_To_Variable") + " \"" + record.getCellValue("Relationship") + "\"" + " \"" + record.getCellValue(
                                           "Description") + "\""));
